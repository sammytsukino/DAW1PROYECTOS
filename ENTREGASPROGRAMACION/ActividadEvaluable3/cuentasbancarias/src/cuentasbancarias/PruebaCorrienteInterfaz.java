...
/**
 * Clase de prueba para demostrar el funcionamiento de CuentaCorrienteInterfaz.
 */
public class PruebaCorrienteInterfaz {
    public static void main(String[] args) {
        // Crear una cuenta corriente con saldo inicial de 10000 y tasa anual del 6%
        InterfazCuenta miCuenta = new CuentaCorrienteInterfaz(10000, 0.06f);
