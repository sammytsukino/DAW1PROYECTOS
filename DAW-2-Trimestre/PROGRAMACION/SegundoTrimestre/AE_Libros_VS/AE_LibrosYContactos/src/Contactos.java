...
public class Contactos {
    ...
    /* 
     * Método principal que inicia el programa, muestra el menú
     * y maneja la selección de opciones del usuario
     */
    ...
    /* 
     * Método que carga los contactos desde el archivo de texto
     * al ArrayList al iniciar el programa
     */
    private static void cargarContactos() {
         ...
         * y añade cada línea al ArrayList de contactos
         */
    ...
    /* 
     * Método que guarda todos los contactos del ArrayList
     * en el archivo de texto antes de salir
     */
    private static void guardarContactos() {
        /* 
         * Escribe cada contacto en una línea del archivo
         * usando BufferedWriter para mejor rendimiento
         */
    ...
    /* 
     * Método que solicita datos al usuario y
    ...
    /* 
     * Método que muestra todos los contactos
    ...
    /* 
     * Método que busca contactos por nombre
     * y muestra los resultados que coinciden
     */
    private static void buscarContacto() {
        ...
        /* 
         * Busca coincidencias en cada contacto
