            ...
            switch (menu) {
                ...
                case 2:
                    ...
                    if (retirar > saldo) {
                        ...
                        saldo -= retirar;
                        System.out.println(
                                "Has retirado " + retirar + " euros." + " Tu saldo actual es de " + saldo + " euros.");
                    }
                    break;
                case 3:
                    ...
                    saldo += depositar;
                    System.out.println(
                            "Has depositado " + depositar + " euros." + " Tu saldo actual es de " + saldo + " euros.");
                    break;
                case 4:
