...
public class MainAsignaciones {
    public static void main(String[] args) {
        String url = "jdbc:oracle:thin:@localhost:1521:xe"; // Ajustar a tu entorno
            ...
            while (true) {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        String insertSQL = "INSERT INTO asignaciones_obj VALUES (" +
                                "tipo_asignacion(?, TO_DATE(?, 'YYYY-MM-DD'), " +
                                "" +
                                "tipo_proyecto(?, ?, TO_DATE(?, 'YYYY-MM-DD'), )" +
                                "))";
                    ...
                    case 2:
                        ...
                        try (Statement stmt = conn.createStatement();
                            ...
                            while (rs.next()) {
                                System.out.printf("Asignación ID: %d | Fecha: %s | Trabajador: %s (%s) | Proyecto: %s | Camino: %s\n",
