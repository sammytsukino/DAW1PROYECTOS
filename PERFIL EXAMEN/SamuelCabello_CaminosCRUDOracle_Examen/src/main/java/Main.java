            ...
            while (true) {
                ...
                switch (opcion) {
                    case 1:
                        ...
                        String insertSQL = "INSERT INTO caminos_obj (id_camino, nombre, longitud, tipo_terreno) VALUES (?, ?, ?, ?)";
                        try (PreparedStatement ps = conn.prepareStatement(insertSQL)) {
                            ps.setInt(1, id);
                            ps.setString(2, nombre);
                            ps.setDouble(3, longitud);
                            ps.setString(4, tipoTerreno);
                            ps.executeUpdate();
                            System.out.println("Camino insertado correctamente.");
                        } catch (SQLException e) {
                            System.out.println("Error al insertar camino: " + e.getMessage());
                        }
                        break;

                    case 2:
                        String selectSQL = "SELECT * FROM caminos_obj";
                        try (Statement stmt = conn.createStatement();
                            ...
                            System.out.println("Error al listar caminos: " + e.getMessage());
                        }
                        break;
                    ...
                    case 3:
                        ...
                        try (PreparedStatement ps = conn.prepareStatement(updateSQL)) {
                            ...
                            System.out.println("Error al actualizar camino: " + e.getMessage());
                        }
                        break;
                    ...
                    case 4:
                        ...
                        try (PreparedStatement ps = conn.prepareStatement(deleteSQL)) {
                            ...
                            System.out.println("Error al eliminar camino: " + e.getMessage());
                        }
                        break;
